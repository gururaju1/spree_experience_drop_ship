...
describe 'Admin - Shipments', js: true do
  ...
  context 'as Experience' do
    ...
    let!(:product) {
      ...
      p.add_experience! experience.id
      p
    }

    let!(:shipment) { create(:shipment, order: order, stock_location: experience.stock_locations.first) }
    ...
    before do
      ...
      user = create(:user, experience: experience)
    ...
    it 'should render unauthorized visiting another experiences shipment' do
